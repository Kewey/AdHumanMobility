 ...
 */
final class Version20230108221704 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE disruption (id INT NOT NULL, author_id INT NOT NULL, transport_type VARCHAR(255) NOT NULL, content TEXT NOT NULL, lat DOUBLE PRECISION NOT NULL, long DOUBLE PRECISION NOT NULL, priority VARCHAR(255) NOT NULL, evidences_path VARCHAR(255) DEFAULT NULL, created_at TIMESTAMP(0) WITHOUT TIME ZONE NOT NULL, updated_at TIMESTAMP(0) WITHOUT TIME ZONE NOT NULL, PRIMARY KEY(id))');
